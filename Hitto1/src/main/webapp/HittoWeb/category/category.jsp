...
<head>
  ...
  <title>카테고리별 상품 - HittoStore</title>
    ...
    <div class="container">
      <ul class="nav-menu">
        <li><a href="#"><i class="fas fa-th-large"></i> 카테고리</a>
          <ul class="sub-menu">
            <li><a href="category.jsp?type=glove">글러브/미트</a></li>
            <li><a href="category.jsp?type=bat">배트</a></li>
            <li><a href="category.jsp?type=ball">야구공</a></li>
            <li><a href="category.jsp?type=clothing">의류/잠바</a></li>
            <li><a href="category.jsp?type=shoes">신발/스파이크</a></li>
            <li><a href="category.jsp?type=equipment">장비용품</a></li>
          </ul>
        </li>
  ...
  <section class="category-content">
    <div class="container">
      ...
      <div class="category-header">
        <h2 id="category-title">카테고리 제목</h2>
        <div class="category-description">최고 품질의 상품들을 만나보세요</div>
      </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (typeof window.initWishlistButtons === 'function') {
        console.log('카테고리 페이지: 위시리스트 버튼 초기화 시작');
        setTimeout(() => {
      ...
      if (typeof window.initCartButtons === 'function') {
        console.log('카테고리 페이지: 장바구니 버튼 초기화 시작');
        setTimeout(() => {
