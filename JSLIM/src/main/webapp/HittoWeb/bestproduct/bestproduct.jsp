...
<head>
  ...
  <title>베스트상품 - HittoStore</title>
  <link rel="icon" href="../images/logo.png" type="image/png">
  <link rel="stylesheet" href="../css/style.css">
  <link rel="stylesheet" href="bestproduct.css">
...
<div class="top-menu-right">
  ...
  <nav class="main-nav">
    <div class="container">
      <ul class="nav-menu">
        ...
        <li><a href="bestproduct.jsp">베스트상품</a></li>
  ...
  <!-- 베스트상품 콘텐츠 영역 -->
  <section class="bestproduct-content">
    <div class="container">
      <!-- 베스트상품 제목 -->
      <div class="bestproduct-header">
        <h2>베스트상품</h2>
        <div class="bestproduct-description">히토스토어 고객들이 가장 많이 구매한 인기 상품입니다</div>
      </div>
      ...
      <!-- 상품 목록 -->
      <div class="product-list" id="best-product-list">
        <!-- 여기에 상품이 동적으로 로드됩니다 -->
      </div>
...
<script src="../js/main.js"></script>
  <script>
    // main.js에서 정의된 products 객체가 없는 경우 대비
    console.log("products 객체 확인:", window.products ? "있음" : "없음");
  </script>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (typeof window.initWishlistButtons === 'function') {
        console.log('베스트상품 페이지: 위시리스트 버튼 초기화 시작');
        setTimeout(() => {
      ...
      if (typeof window.initCartButtons === 'function') {
        console.log('베스트상품 페이지: 장바구니 버튼 초기화 시작');
        setTimeout(() => {
